...
def streamlit_app():
    ...
    with tab2:
        ...
        with col1:
            ...
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(teams_df.iloc[0][1])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>1st / Form (Last 5):</b> {((teams_df.iloc[0][2])[-5:])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
        ...
        with col2:
            # Second top team.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(teams_df.iloc[1][1])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>2nd / Form (Last 5):</b> {((teams_df.iloc[1][2])[-5:])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
        ...
        with col3:
            # Third top team.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(teams_df.iloc[2][1])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>3rd / Form (Last 5):</b> {((teams_df.iloc[2][2])[-5:])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
        ...
        with col4:
            # Fourth top team.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(teams_df.iloc[3][1])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>4th / Form (Last 5):</b> {((teams_df.iloc[3][2])[-5:])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
        ...
        with col5:
            # Fifth top team.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(teams_df.iloc[4][1])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>5th / Form (Last 5):</b> {((teams_df.iloc[4][2])[-5:])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
        ...
        with col1:
            # First top scorer.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(players_df.iloc[0][5])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>{(players_df.iloc[0][0])}</b></p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Goals:</b> {(players_df.iloc[0][1])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Assists:</b> {(players_df.iloc[0][3])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Team:</b> {(players_df.iloc[0][2])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Nationality:</b> {(players_df.iloc[0][4])}</p>",
                unsafe_allow_html=True,
            )
        ...
        with col2:
            # Second top scorer.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(players_df.iloc[1][5])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>{(players_df.iloc[1][0])}</b></p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Goals:</b> {(players_df.iloc[1][1])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Assists:</b> {(players_df.iloc[1][3])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Team:</b> {(players_df.iloc[1][2])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Nationality:</b> {(players_df.iloc[1][4])}</p>",
                unsafe_allow_html=True,
            )
        ...
        with col3:
            # Third top scorer.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(players_df.iloc[2][5])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>{(players_df.iloc[2][0])}</b></p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Goals:</b> {(players_df.iloc[2][1])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Assists:</b> {(players_df.iloc[2][3])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Team:</b> {(players_df.iloc[2][2])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Nationality:</b> {(players_df.iloc[2][4])}</p>",
                unsafe_allow_html=True,
            )
        ...
        with col4:
            # Fourth top scorer.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(players_df.iloc[3][5])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>{(players_df.iloc[3][0])}</b></p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Goals:</b> {(players_df.iloc[3][1])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Assists:</b> {(players_df.iloc[3][3])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Team:</b> {(players_df.iloc[3][2])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Nationality:</b> {(players_df.iloc[3][4])}</p>",
                unsafe_allow_html=True,
            )
        ...
        with col5:
            # Fifth top scorer.
            st.markdown(
                f"<img style='display: block; margin-left: auto; margin-right: auto; width: 150px;' src='{(players_df.iloc[4][5])}'/>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center; padding-top: 0.8rem;'><b>{(players_df.iloc[4][0])}</b></p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Goals:</b> {(players_df.iloc[4][1])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Assists:</b> {(players_df.iloc[4][3])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Team:</b> {(players_df.iloc[4][2])}</p>",
                unsafe_allow_html=True,
            )
            st.markdown(
                f"<p style='text-align: center;'><b>Nationality:</b> {(players_df.iloc[4][4])}</p>",
                unsafe_allow_html=True,
            )
